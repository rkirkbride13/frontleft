...
describe("/users", () => {
    ...
    describe("post when email and password are provided", () => {
        it("gives response code 201 and creates a user", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("post when name not provided", () => {
        it("gives response code 400 and does NOT create user", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("post when email exists in DB", () => {
        it("gives response code 400 and does NOT create user", () => __awaiter(void 0, void 0, void 0, function* () {
            yield users_1.default.create({ name: "Robbie", email: "robbie@email.com", password: "password1" });
            let response = yield (0, supertest_1.default)(app_1.app)
                .post("/users")
